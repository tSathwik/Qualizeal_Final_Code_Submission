  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        `${import.meta.env.VITE_REACT_DOMAIN}/signup/devices`,
        {
          method: "POST",
          headers: {
...
//       if (!response.ok) {
//         throw new Error("Failed to submit devices");
//       }
...
//     <div className="flex flex-col md:flex-row min-h-screen bg-gray-100">
//       <SignupImage />
//       <div className="flex-1 p-8 flex flex-col justify-center bg-white rounded-lg shadow-lg">
//         <h2 className="text-3xl font-extrabold mb-4">Add Your Devices</h2>
//         <form
//           onSubmit={handleSubmit}
