...
//       console.log("Verified successfully... redirecting to profile page");
//     } else {
...
// app.put("/updatePersonalInfo/:id", async (req, res) => {
//   const userId = req.params.id;
//   const { first_name, last_name, email, dob, mobile_no } = req.body;

//   const query = `
//     UPDATE tester
//     SET first_name = ?, last_name = ?, email = ?, dob = ?, mobile_no = ?
//     WHERE userId = ?
//   `;
//   const values = [first_name, last_name, email, dob, mobile_no, userId]; // Corrected the order of values
